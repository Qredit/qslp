...
// ASLP-1 / ASLP-2 Schema and Functions
// ==========================
...
var aslpSchema = /** @class */ (function () {

	/* Vars */

	const AslpMasterAddress = "ARKQXzHvEWXgfCgAcJWJQKUMus5uE6Yckr";

	const activationHeight = 17891337;
	const activationHeightAslp2 = 17891337;

	// Use default values before these heights
	const mintableActivationHeight = 17891337;
	const pausableActivationHeight = 17891337;
	const pausableActivationHeightAslp2 = 17891337;

	const schemaVersion = 15;

	const AslpTransactionType = {
		"GENESIS": "GENESIS",
		"MINT": "MINT",
		"SEND": "SEND",
		"BURN": "BURN",
	...
	const AslpTransactionTypeHeight = {
		"GENESIS": 17891337,
		"MINT": 17891337,
		"SEND": 17891337,
		"BURN": 17891337,
	...
	const Aslp2TransactionTypeHeight = {
		"GENESIS": 17891337,
		"PAUSE": 17891337,
		"RESUME": 17891337,
		"NEWOWNER": 17891337,
	...
	const AslpGenesisCostHeight = {
		1: 1,
		17891337: 100000000
	};

	const Aslp2GenesisCostHeight = {
		1: 1,
		17891337: 100000000
	};
	...
	const AslpTransactionOutput = Interface('AslpTransactionOutput')({
	...
	const AslpTransactionDetails = Interface('AslpTransactionDetails')({
		schema_version: type('number'),
		...
		sendOutput: type('object', AslpTransactionOutput),
		note: type('string'),
		amount_ark: type('string'),
		fee_ark: type('string')
	}, {
		error: true,
		strict: true
	...
	const AslpTokenDetails = Interface('AslpTokenDetails')({
		schema_version: type('number'),
	...
	const AslpTokenStats = Interface('AslpTokenStats')({
		schema_version: type('number'),
		...
		qty_ark_spent: type('string')
	}, {
		error: true,
		strict: true
	});

	const AslpTokenObject = Interface('AslpTokenObject')({
		schema_version: type('number'),
		type: type('string'),
		paused: type('boolean'),
		tokenDetails: type('object', AslpTokenDetails),
		tokenStats: type('object', AslpTokenStats),
	...
	const AslpAddressObject = Interface('AslpAddressObject')({
		schema_version: type('number'),
	...
	const AslpTransactionObject = Interface('AslpTransactionObject')({
		schema_version: type('number'),
		txid: type('string'),
		blockId: type('string'),
		...
		transactionDetails: type('object', AslpTransactionDetails)
	}, {
		error: true,
		strict: true
	});
	...
	const Aslp2TokenDetails = Interface('Aslp2TokenDetails')({
		schema_version: type('number'),
		ownerAddress: type('string'),
		tokenIdHex: type('string'),
		versionType: type('number'),
	...
	const Aslp2TokenStats = Interface('Aslp2TokenStats')({
		schema_version: type('number'),
		block_created_height: type('number'),
		block_created_id: type('string'),
	...
	const Aslp2TokenObject = Interface('Aslp2TokenObject')({
		schema_version: type('number'),
		type: type('string'),
		paused: type('boolean'),
		parent: type('string'),
		tokenDetails: type('object', Aslp2TokenDetails),
		tokenStats: type('object', Aslp2TokenStats),
		lastUpdatedBlock: type('number')
	}, {
		error: true,
		strict: true
	...
	const Aslp2AddressObject = Interface('Aslp2AddressObject')({
		schema_version: type('number'),
		recordId: type('string'),
		address: type('string'),
		tokenIdHex: type('string'),
	...
	const Aslp2MetaDetails = Interface('Aslp2MetaDetails')({
		schema_version: type('number'),
	...
	const Aslp2MetaObject = Interface('Aslp2MetaObject')({
		schema_version: type('number'),
		txid: type('string'),
		blockId: type('string'),
		blockHeight: type('number'),
		metaDetails: type('object', Aslp2MetaDetails),
		void: type('boolean')
	}, {
		error: true,
		strict: true
	...
	const Aslp2TransactionDetails = Interface('Aslp2TransactionDetails')({
		schema_version: type('number'),
		transactionType: type('string'),
		senderAddress: type('string'),
		tokenIdHex: type('string'),
	...
	const Aslp2TransactionObject = Interface('Aslp2TransactionObject')({
		schema_version: type('number'),
		txid: type('string'),
		blockId: type('string'),
		blockHeight: type('number'),
		valid: type('boolean'),
		invalidReason: type('string'),
		transactionDetails: type('object', Aslp2TransactionDetails)
	}, {
		error: true,
		strict: true
	});
	...
	aslpSchema.prototype.getTransactionTypes = function () {

		return AslpTransactionType;

	};

	aslpSchema.prototype.getAslp2TransactionTypes = function () {

		return Aslp2TransactionType;

	};

	aslpSchema.prototype.parseTransaction = function (txdata, bkdata, qdb) {
		...
		return new Promise((resolve, reject) => {
			...
			(async () => {
				...
				if (vendorData && vendorData.aslp1 && blockData.height >= activationHeight) {

					console.log('test1');

					var contractData = vendorData.aslp1;
					...
					*/
					...
					if (!AslpTransactionType[contractData.tp]) //contractData.tp != 'GENESIS' && contractData.tp != 'MINT' && contractData.tp != 'BURN' && contractData.tp != 'SEND')
					{
						// Invalid Type
					...
					if (AslpTransactionTypeHeight[contractData.tp] > blockData.height) {
						// Invalid Type
					...
					if (contractData.tp == 'GENESIS') {
						...
						for (var costHeight in AslpGenesisCostHeight) {
							console.log(costHeight + ": " + AslpGenesisCostHeight[costHeight]);

							var bigCostHeight = Big(costHeight);
							var bigTestHeight = Big(blockData.height);
							if (bigTestHeight.gte(bigCostHeight)) {
								GenesisTransactionCost = Big(AslpGenesisCostHeight[costHeight]);
							}
						}
						...
						if (GenesisTransactionCost.gt(totalFeesAmount)) {
							validationcheck = false;
							invalidreason = 'Generation Fee unsufficient.  ' + GenesisTransactionCost.toFixed(0) + ' ARK required';
						}
					...
					if (validationcheck === false) {
						...
						var TransactionDetails = {
							...
							note: '',
							amount_ark: Big(transactionData.amount).toFixed(0),
							fee_ark: Big(transactionData.fee).toFixed(0)
						}
						...
						if (contractData.tp == 'GENESIS' && transactionData.recipient == AslpMasterAddress) {
							// New Token Request
							...
							try {
								...
								implement(AslpTransactionOutput)(TransactionOutput);
							...
							var rawTokenId = 'ASLP1.' + contractData.sy + '.' + blockData.height + '.' + transactionData.id;
							...
							try {
								...
								implement(AslpTransactionDetails)(TransactionDetails);
							...
							try {
								...
								implement(AslpTokenDetails)(TokenDetails);
							...
							var TokenStats = {
								...
								qty_ark_spent: Big(transactionData.amount).toFixed(0)
							}

							try {

								implement(AslpTokenStats)(TokenStats);
							...
							try {
								...
								implement(AslpTokenObject)(TokenObject);
							...
							try {
								...
								implement(AslpAddressObject)(AddressObject);
							...
							try {
								...
								implement(AslpTransactionObject)(TransactionObject);
						...
						else if (contractData.tp == 'MINT' && transactionData.recipient == AslpMasterAddress) {
							// Mint more tokens
							...
							var findToken = await qdb.findDocument('tokens', { $and: [{ "tokenDetails.tokenIdHex": tokenId }, { "type": "ASLP1" }] });
							...
							if (findToken == null) {
								...
								if (failed === false) {
									...
									if (findSenderAddress == null) {
										...
										await qdb.updateDocument('tokens', { "tokenDetails.tokenIdHex": tokenId }, { "lastUpdatedBlock": blockData.height, "tokenStats.block_last_active_send": blockData.height, "tokenStats.qty_valid_txns_since_genesis": newValidTxns, "tokenStats.qty_valid_token_addresses": newTokenAddrs, "tokenStats.qty_ark_spent": Big(arkspent).toFixed(0) });

										await qdb.createJournalEntry(transactionData.id, blockData.id, blockData.height, transactionData.timestamp.human, transactionData.timestamp.unix, 'update', 'tokens', { "tokenDetails.tokenIdHex": tokenId }, { "lastUpdatedBlock": blockData.height, "tokenStats.block_last_active_send": blockData.height, "tokenStats.qty_valid_txns_since_genesis": newValidTxns, "tokenStats.qty_valid_token_addresses": newTokenAddrs, "tokenStats.qty_ark_spent": Big(arkspent).toFixed(0) });
						...
						else if (contractData.tp == 'BURN' && transactionData.recipient == AslpMasterAddress) {
							// Burn tokens
						...
						else if (contractData.tp == 'PAUSE' && transactionData.recipient == AslpMasterAddress) {
							...
							if (findToken == null) {
								...
								if (findSenderAddress == null) {
									...
									if (failed === false) {
										...
										await qdb.updateDocument('tokens', { "tokenDetails.tokenIdHex": tokenId }, { "paused": true, "lastUpdatedBlock": blockData.height, "tokenStats.qty_valid_txns_since_genesis": newValidTxns, "tokenStats.qty_ark_spent": Big(arkspent).toFixed(0) });

										await qdb.createJournalEntry(transactionData.id, blockData.id, blockData.height, transactionData.timestamp.human, transactionData.timestamp.unix, 'update', 'tokens', { "tokenDetails.tokenIdHex": tokenId }, { "paused": true, "lastUpdatedBlock": blockData.height, "tokenStats.qty_valid_txns_since_genesis": newValidTxns, "tokenStats.qty_ark_spent": Big(arkspent).toFixed(0) });
						...
						else if (contractData.tp == 'RESUME' && transactionData.recipient == AslpMasterAddress) {
							...
							if (findToken == null) {
								...
								if (findSenderAddress == null) {
									...
									if (failed === false) {
										...
										await qdb.updateDocument('tokens', { "tokenDetails.tokenIdHex": tokenId }, { "paused": false, "lastUpdatedBlock": blockData.height, "tokenStats.qty_valid_txns_since_genesis": newValidTxns, "tokenStats.qty_ark_spent": Big(arkspent).toFixed(0) });

										await qdb.createJournalEntry(transactionData.id, blockData.id, blockData.height, transactionData.timestamp.human, transactionData.timestamp.unix, 'update', 'tokens', { "tokenDetails.tokenIdHex": tokenId }, { "paused": false, "lastUpdatedBlock": blockData.height, "tokenStats.qty_valid_txns_since_genesis": newValidTxns, "tokenStats.qty_ark_spent": Big(arkspent).toFixed(0) });
						...
						else if (contractData.tp == 'NEWOWNER' && transactionData.recipient != AslpMasterAddress) {
							...
							if (findToken == null) {
								...
								if (findSenderAddress == null) {
									...
									if (failed === false) {
										...
										await qdb.updateDocument('tokens', { "tokenDetails.tokenIdHex": tokenId }, { "tokenDetails.ownerAddress": transactionData.recipient, "lastUpdatedBlock": blockData.height, "tokenStats.qty_valid_txns_since_genesis": newValidTxns, "tokenStats.qty_ark_spent": Big(arkspent).toFixed(0) });

										await qdb.createJournalEntry(transactionData.id, blockData.id, blockData.height, transactionData.timestamp.human, transactionData.timestamp.unix, 'update', 'tokens', { "tokenDetails.tokenIdHex": tokenId }, { "tokenDetails.ownerAddress": transactionData.recipient, "lastUpdatedBlock": blockData.height, "tokenStats.qty_valid_txns_since_genesis": newValidTxns, "tokenStats.qty_ark_spent": Big(arkspent).toFixed(0) });
						...
						else if (contractData.tp == 'FREEZE' && transactionData.recipient != AslpMasterAddress) {
							...
							if (findToken == null) {
								...
								if (findSenderAddress == null) {
									...
									if (failed === false && findRecipientAddress !== null) {
										...
										await qdb.updateDocument('tokens', { "tokenDetails.tokenIdHex": tokenId }, { "lastUpdatedBlock": blockData.height, "tokenStats.qty_valid_txns_since_genesis": newValidTxns, "tokenStats.qty_ark_spent": Big(arkspent).toFixed(0) });

										await qdb.createJournalEntry(transactionData.id, blockData.id, blockData.height, transactionData.timestamp.human, transactionData.timestamp.unix, 'update', 'tokens', { "tokenDetails.tokenIdHex": tokenId }, { "lastUpdatedBlock": blockData.height, "tokenStats.qty_valid_txns_since_genesis": newValidTxns, "tokenStats.qty_ark_spent": Big(arkspent).toFixed(0) });
						...
						else if (contractData.tp == 'UNFREEZE' && transactionData.recipient != AslpMasterAddress) {
						...
						else if ((contractData.tp == 'FREEZE' || contractData.tp == 'UNFREEZE') && transactionData.recipient == AslpMasterAddress) {
							...
							var TransactionObject = {
								...
								blockHeight: blockData.height,
								valid: false,
								invalidReason: 'ASLP1 Token - This command must be sent to the address which to take action,',
								transactionDetails: TransactionDetails
							}
							...
							// Invalid command
							console.log("ASLP1 - Invalid Command");

							resolve(false);

						}
						else if ((contractData.tp == 'GENESIS' || contractData.tp == 'MINT' || contractData.tp == 'BURN' || contractData.tp == 'PAUSE' || contractData.tp == 'RESUME') && transactionData.recipient != AslpMasterAddress) {
							...
							var TransactionObject = {
								...
								blockHeight: blockData.height,
								valid: false,
								invalidReason: 'ASLP1 Token - This command must be sent to the Master ASLP Address: ' + AslpMasterAddress,
								transactionDetails: TransactionDetails
							}
							...
							var TransactionObject = {
								...
								blockHeight: blockData.height,
								valid: false,
								invalidReason: 'ASLP1 Token - Invalid Command',
								transactionDetails: TransactionDetails
							}
				...
				/* ASLP-2 Parser */
				if (vendorData && vendorData.aslp2 && blockData.height >= activationHeightAslp2) {

					var contractData = vendorData.aslp2;
					...
					*/
					...
					if (!Aslp2TransactionType[contractData.tp]) {
						// Invalid Type
					...
					if (Aslp2TransactionTypeHeight[contractData.tp] > blockData.height) {
						// Invalid Type
					...
					if (contractData.tp == 'GENESIS') {
						...
						// Check Transaction Cost
						var GenesisTransactionCost = Big(1);
						for (var costHeight in Aslp2GenesisCostHeight) {
							console.log(costHeight + ": " + Aslp2GenesisCostHeight[costHeight]);

							var bigCostHeight = Big(costHeight);
							var bigTestHeight = Big(blockData.height);
							if (bigTestHeight.gte(bigCostHeight)) {
								GenesisTransactionCost = Big(Aslp2GenesisCostHeight[costHeight]);
							}
						}
						...
						if (contractData.pa && contractData.pa.toString() == "true") {
							...
							if (pausableActivationHeightAslp2 > blockData.height) {
								contractData.pa = true;
							}
							else {
								contractData.pa = false;
					...
					if (validationcheck === false) {
						...
						if (contractData.tp == 'GENESIS' && transactionData.recipient == AslpMasterAddress) {
							...
							var rawTokenId = 'ASLP2.' + contractData.sy + '.' + blockData.height + '.' + transactionData.id;
							var tokenId = SparkMD5.hash(rawTokenId);
							...
							try {
								...
								implement(Aslp2TransactionDetails)(TransactionDetails);
							...
							try {
								...
								implement(Aslp2TokenDetails)(TokenDetails);
							...
							try {
								...
								implement(Aslp2TokenStats)(TokenStats);
							...
							try {
								...
								implement(Aslp2TokenObject)(TokenObject);
							...
							try {
								...
								implement(Aslp2AddressObject)(AddressObject);
							...
							try {
								...
								implement(Aslp2TransactionObject)(TransactionObject);
							...
							var findToken = await qdb.findDocument('tokens', { $and: [{ "tokenDetails.tokenIdHex": tokenId }, { "type": "ASLP2" }] });
						...
						else if (contractData.tp == 'CLONE' && transactionData.recipient == AslpMasterAddress) {
							...
							if (findToken == null) {
								...
								if (findSenderAddress == null) {
									...
									var rawTokenIdClone = 'ASLP2.' + contractData.sy + '.' + blockData.height + '.' + transactionData.id;
									...
									try {
										...
										implement(Aslp2TransactionDetails)(TransactionDetailsclone);
									...
									try {
										...
										implement(Aslp2TransactionObject)(TransactionObjectClone);
						...
						else if (contractData.tp == 'ADDMETA' && transactionData.recipient == AslpMasterAddress) {
								...
								if (failed === false) {
									...
									if (findSenderAddress == null) {
										...
										try {
											...
											implement(Aslp2MetaDetails)(MetaDetails);
										...
										try {
											...
											implement(Aslp2MetaObject)(MetaObject);
										...
										await qdb.updateDocument('tokens', { "tokenDetails.tokenIdHex": tokenId }, { "lastUpdatedBlock": blockData.height, "tokenStats.block_last_active_meta": blockData.height, "tokenStats.qty_valid_txns_since_genesis": newValidTxns, "tokenStats.qty_valid_meta_since_genesis": newTokenMetas, "tokenStats.qty_ark_spent": Big(arkspent).toFixed(0) });
						...
						else if (contractData.tp == 'VOIDMETA' && transactionData.recipient == AslpMasterAddress) {
						...
						else if (contractData.tp == 'AUTHMETA' && transactionData.recipient != AslpMasterAddress) {
						...
						else if (contractData.tp == 'REVOKEMETA' && transactionData.recipient != AslpMasterAddress) {
							...
							if (findToken == null) {
								...
								if (findSenderAddress == null) {
									...
									if (failed === false && findRecipientAddress !== null) {
										...
										await qdb.updateDocument('tokens', { "tokenDetails.tokenIdHex": tokenId }, { "lastUpdatedBlock": blockData.height, "tokenStats.qty_valid_txns_since_genesis": newValidTxns, "tokenStats.qty_valid_metaauth_addresses": newAuthMetaAddrs, "tokenStats.qty_ark_spent": Big(arkspent).toFixed(0) });
						...
						else if ((contractData.tp == 'AUTHMETA' || contractData.tp == 'REVOKEMETA') && transactionData.recipient == AslpMasterAddress) {
							...
							var TransactionObject = {
								...
								blockHeight: blockData.height,
								valid: false,
								invalidReason: 'ASLP2 Token - This command must be sent to the address which to take action,',
								transactionDetails: TransactionDetails
							}
							...
							// Invalid command
							console.log("ASLP2 - Invalid Command");

							resolve(false);


						}
						else if ((contractData.tp == 'GENESIS' || contractData.tp == 'CLONE' || contractData.tp == 'ADDMETA' || contractData.tp == 'PAUSE' || contractData.tp == 'RESUME') && transactionData.recipient != AslpMasterAddress) {
							...
							var TransactionObject = {
								...
								blockHeight: blockData.height,
								valid: false,
								invalidReason: 'ASLP2 Token - This command must be sent to the Master ASLP Address: ' + AslpMasterAddress,
								transactionDetails: TransactionDetails
							}
							...
							var TransactionObject = {
								...
								blockHeight: blockData.height,
								valid: false,
								invalidReason: 'ASLP2 Token - Invalid Command',
								transactionDetails: TransactionDetails
							}
	...
	aslpSchema.prototype.indexDatabase = function (qdb) {
