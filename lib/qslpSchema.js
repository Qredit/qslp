...
var qslpSchema = /** @class */ (function () {
	...
	const activationHeight = 1579800;
	const activationHeightQslp2 = 1579800;

	// Use default values before these heights
	const mintableActivationHeight = 1579800;
	const pausableActivationHeight = 1579800;
	const pausableActivationHeightQslp2 = 1579800;
			...
			if (vendorData && vendorData.qslp1 && blockData.height >= activationHeight) {
				...
				*/
				...
				if (contractData.tp == 'GENESIS') {
					...
					if (contractData.du && contractData.du.length > 125) {
					...
					if (contractData.no && contractData.no.length > 125) {
