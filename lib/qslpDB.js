...
var qslpDB = /** @class */ (function () {
	...
	function qslpDB(connectionString, dbName) {
	...
	qslpDB.prototype.connect = function () {
	...
	qslpDB.prototype.setClient = function (client) {
	...
	qslpDB.prototype.ping = function () {
	...
	qslpDB.prototype.close = function (client) {
	...
	qslpDB.prototype.getConnectionString = function () {

		return this.connectionString;

	};

	qslpDB.prototype.findDocument = function (collection, query) {
	...
	qslpDB.prototype.findDocuments = function (collection, query, limit = 100, sort = {}, skip = 0) {
	...
	qslpDB.prototype.findDocumentsWithId = function (collection, query, limit = 100, sort = {}, skip = 0) {
	...
	qslpDB.prototype.findDocumentCount = function (collection, query) {
	...
	qslpDB.prototype.findDocumentBigSum = function (collection, query, sumfield) {
	...
	qslpDB.prototype.findDocumentHash = function (collection, query, field, sort) {
	...
	qslpDB.prototype.insertDocument = function (collection, query) {
	...
	qslpDB.prototype.insertDocuments = function (collection, query) {
	...
	qslpDB.prototype.createJournalEntry = function (txid, blockId, blockHeight, timestamp, timestampUnix, action, collectionName, fieldData, recordData) {
	...
	qslpDB.prototype.updateDocument = function (collection, findquery, setquery) {
	...
	qslpDB.prototype.removeDocument = function (collection, query) {
	...
	qslpDB.prototype.removeDocuments = function (collection, query) {
	...
	qslpDB.prototype.createIndex = function (collection, query, unique = true) {
	...
	qslpDB.prototype.createCollection = function (collection, options = {}) {
	...
	qslpDB.prototype.doesCollectionExist = function (collection) {
